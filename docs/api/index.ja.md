...
| `Fmrb::Fft` | 高速フーリエ変換 (実装は実行時に選べます) | [ユーティリティ](utilities.md#fmrbfft) |
...
| `BMI270` | 6 軸センサ (Modern) | [ハードウェア制御](peripherals.md#6-軸センサ-bmi270modern-のみ) |
| `RX8900` / `RX8130` | 電池つきの時計 (RTC) | [ハードウェア制御](peripherals.md#時計-rx8900--rx8130) |
