...
!!! note "Library format"
    P5 is not built into the firmware. It is a loadable library located at `/lib/p5.rb`, and only apps that use it import it with `require "p5"`. The footprint only applies to apps that use P5.
